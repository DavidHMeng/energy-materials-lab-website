...
| Publications | DOI is the single identifier in `_data/publications.yaml`; generated registry and Greene citation pipeline retained | DOI source registry and citations are rebuilt from independent memberships | Hosted publication route inspected | Publications file editor and DOI refresh action configured |
