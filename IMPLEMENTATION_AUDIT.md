...
| Homepage | Introduction with bilingual copy and A/B visual carousel above Highlights and Events | Previous EN/ZH routes passed; V1.3 production validation pending current change | Previous routes inspected; V1.3 motion/carousel inspection pending deployment | Introduction copy, slides, types, alt, order and timing exposed |
...
| Team | CMS-maintained role labels, compact circular portrait grid, active/display filters and empty-group suppression | Source validation passes; V1.3 production validation pending | Previous EN/ZH routes inspected; V1.3 compact grid inspection pending | Members and Team Role Labels exposed as structured editors |
| Member optional fields | Profiles show email/academic links, interests, education and optional plain-text Personal Note; no phone/office/publications | Source validation passes; V1.3 production validation pending | V1.3 profile inspection pending deployment | Personal Note is plain text; retired fields are not exposed |
...
| Motion and responsive UI | Native cross-page transitions, restrained card/link motion, reveal effects, carousel controls and reduced-motion fallback | JavaScript syntax and source validation pass; V1.3 production build pending | V1.3 desktop/mobile/motion inspection pending deployment | Carousel interval, order and visibility are editable |
