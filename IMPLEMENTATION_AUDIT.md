...
| Homepage | Implemented: `index.md`, `zh/index.md`; only Highlights and Events below header | EN/ZH routes built and link-checked | EN/ZH hosted pages load; desktop and 320 px layouts inspected | Homepage settings loaded in CMS |
...
| Team | Fixed role groups, active/display filters, empty-group suppression | Roles, slugs, portraits, alts and bilingual routes pass | EN/ZH Team and member profiles inspected | Collection loaded from live schema |
| Member optional fields | Empty optional values are suppressed in `_layouts/profile.html` | HTML Proofer found no empty anchors | Profile pages inspected | Optional fields exposed without code fields |
...
| Responsive | Custom 900 px and 700 px breakpoints; reduced-motion handling | Sass compiles in production | Desktop and final uncached 320 px checks pass without horizontal overflow | Not applicable |
