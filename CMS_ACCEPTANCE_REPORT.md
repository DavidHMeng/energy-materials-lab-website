...
- Final branch validation run: https://github.com/DavidHMeng/energy-materials-lab-website/actions/runs/36117027301
- Citation synchronization run: https://github.com/DavidHMeng/energy-materials-lab-website/actions/runs/36114896174
- A successful staging artifact was produced during QA; branch-specific public
  Pages deployment remains intentionally unavailable because the repository
  environment only permits deployment from `main`.
